  ...
  const [modalScroll, setModalScroll] = useState<"normal" | "outside" | "inside">("normal");
    ...
    <>
      <div className="relative w-full h-[170px]">
        <img src={car.fotos[0] || "/carroTeste.png" } className="w-full h-full object-cover" alt={`${car.marca}
          ${car.modelo}`} />
      </div>
      ...
      <CardBody className="overflow-visible pt-2">
        <div>
          ...
          <div className="min-h-6">
            {car.blindado && (
            <Chip startContent={<Shield size={12} />}
            variant="solid"
            color="danger"
            size="sm"
            >
    ...
    return (
    <>
      <Card className="md:w-lg md:h-lg w-sm shadow-xl" radius="sm" isPressable={true} allowTextSelectionOnPress={true}
        isHoverable={true} onClick={onOpen}>
        {renderCardContent()}
      </Card>

      <Modal isOpen={isOpen} size={modalSize} onClose={onClose} scrollBehavior={modalScroll} backdrop="blur"
        ...
        <ModalContent className="">
          ...
          <>
                  ...
                  <Carousel className="">
                    ...
                    <CarouselMainContainer>
                      ...
                      <SliderMainItem key={index} className="bg-transparent">
                        <Image src={foto} radius="none" className="object-cover w-full h-full" // Largura e altura fixas
                    ...
                    <CarouselThumbsContainer>
                      ...
                      <SliderThumbItem key={index} index={index} className="bg-transparent">
                        <img key={index} src={foto} className="w-full h-12 object-cover rounded-lg shadow"
            ...
            <ModalFooter className="flex justify-between">
              <Button color="default" variant="faded" onClick={addToComparador} endContent={<MdCompareArrows
                size={20} />}
              >
